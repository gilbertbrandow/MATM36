...
\]
Thus every point of $W$ lies in some basis element $U\times V\in\mathcal B$ contained in $W$, so $W$ is a union of such basis elements and hence $W\in\mathcal T' implies \mathcal T \subseteq T'$. Therefore $\mathcal T=\mathcal T'$.
\end{proof}
\end{document}