...
Let: 
\[
f: \{0, 1\}^{\mathbb{N}} \to \mathcal{P(\mathbb{N})}, (x_1, x_2 \cdots) \mapsto \sum_{k = 0}^{\infty}x_k
\] 
So we prove f injective, then we construct a g that is surjective and we can therefore conclude there must exist bijection? Or 
\textbf{d: }
